...
# python manage.py runserver --settings=myspirit.settings.prod_local
...
SECRET_KEY = os.environ.get("SECRET_KEY", 'c%4sb-s1qov3=!ftftwyr-6rer5psk22+4b9719&2&cn0zem&z')
